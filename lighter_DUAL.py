...
I am able to be contacted if it happens to cause issues with assessments)
...
ri.Light("PxrRectLight", "cLight", {
    "color lightcolor": [192 / 255, 243 / 255, 255 / 255],  
...
def createLighter(x, z):
    ...
    ri.Bxdf(
        ...
        "plastic",
        {
            ...
            #"reference color specularEdgeColor": ["DustRough:resultRGB"],
    ...
    # hinge bar
    ri.TransformBegin()
    ri.Translate(-0.2, 0.4, 0.65)
    ri.Scale(3.1,0.04,0.04)
    ri.Rotate(90,0,1,0)
    ri.Cylinder(1, -0.5, 0.5, 360)
    ri.TransformEnd()
    ...
    # hinge bar end cap
    ri.TransformBegin()
    ri.Translate(-2, 0.4, 0.65)
    ri.Scale(0.2,0.2,0.045)
    ri.Rotate(270,0,1,0)
    ri.Disk(0, 1, 360)
    ri.TransformEnd()
    ...
    #      "reference color diffuseColor": ["applyScratchMask:resultRGB"]
    # })
    ...
    ri.Pattern("PxrTexture", "wheelDsp", {"filename": "wheelNorm.tx"})
